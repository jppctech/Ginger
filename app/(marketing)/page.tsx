        ...
        <div className="flex items-center justify-center flex-col" >
            <div className={cn(
                ...
                bg-amber-100 text-amber-700 rounded-full uppercase">
                    ...
                    been appreciated for its color and natural
                    beauty since Neolithic times. Much valued 
                    from antiquity to the present as a gemstone,
                    amber is made into a variety of decorative 
                    objects. Amber is used in jewelry and has been
